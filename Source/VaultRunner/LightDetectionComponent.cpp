...
{    
    if (this->GetWorld()->TimeSeconds > timeOfNextUpdate)
    {
        ...
        {
            auto asSkyLight = Cast<USkyLightComponent>(light);
            if (asSkyLight)
            {
            ...
            auto asSpotLight = Cast<USpotLightComponent>(light);
            if (asSpotLight)
            {
            ...
            auto asPointLight = Cast<UPointLightComponent>(light);            
            if (asPointLight)
            {
            ...
            auto asDirectionalLight = Cast<UDirectionalLightComponent>(light);
            if (asDirectionalLight)
            {
